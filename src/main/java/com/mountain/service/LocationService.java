...
public interface LocationService extends IService<Location> {
    ...
    // 动态VRP算法
    Map<Object, ArrayList<Integer>> movePassengerPlan(Long[][] tempDistanceMatrix, Integer vehicleNumber,
            int[] startPosition, int[] depot);

    // 动态保存用户位置
    Boolean dynamicLocationSave(Map<String, GeoJsonPoint> locationMap, Map<String, Location> uavLocation,
