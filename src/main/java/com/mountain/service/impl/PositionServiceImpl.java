...
public class PositionServiceImpl extends ServiceImpl<LocalMapper, Location> implements LocationService {
    ...
    public Assignment computeService(RoutingIndexManager manager, Long[][] distanceMatrix, Integer vehicleNumber,
    ...
    // MDVRP路线规划,多场站路线规划
    @Override
    public Map<Object, ArrayList<Integer>> movePassengerPlan(Long[][] tempDistanceMatrix, Integer vehicleNumber,
            int[] startPosition, int[] depot) {
        Loader.loadNativeLibraries();
        ...
        //
        // final int transitCallbackIndex=planRouting.registerTransitCallback((long
        ...
        // RoutingDimension mutableDimension =
        // planRouting.getMutableDimension("Distance");
        ...
        // .build();
        // Assignment solution =
        // planRouting.solveWithParameters(routingSearchParameters);
    ...
    // 保存动态用户的位置
    @Override
    public Boolean dynamicLocationSave(Map<String, GeoJsonPoint> locationMap, Map<String, Location> uavLocation,
            Map<String, Location> depotLocation) {
    ...
    public Map<Object, ArrayList<Integer>> dynamicRoutes(Map<String, Location> uavLocation) {
        ...
        // 得到规划路线
        Map<Object, ArrayList<Integer>> objectArrayListMap = movePassengerPlan(distanceMatrix, uavSize, startPosition,
                stopPosition);
